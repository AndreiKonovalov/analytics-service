...
Если нужно показать работу профайлеров на реальной нагрузке, используйте готовый сценарий:
- генерация нагрузки на «наивный» и «оптимизированный» эндпоинты,
- сбор CPU/alloc профилей через JFR или async-profiler,
- сравнение результатов и выявление N+1 проблем.
